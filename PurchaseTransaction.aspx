<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseTransaction.aspx.cs" Inherits="PurchaseTransaction" %>
...
<body>
    <form id="form1" runat="server">
        <div class="Transation-management">
            <h2>Purchase Transaction Summary</h2>
            <div class="stats">
            <div class="stat">
                <h3>Total Purchase Amount</h3>
                <div class="amount"><asp:Label ID="lblTotalPurchase" runat="server" Text="₹0"></asp:Label></div>
            </div>
            <div class="stat">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" SelectionMode="Single">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                <asp:Button ID="btnAction" runat="server" Text="View Supplier Bill" CssClass="viewBill button" CommandName="Action" OnClick="btnAction_Click" CommandArgument='<%# Eval("BillNumber") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
